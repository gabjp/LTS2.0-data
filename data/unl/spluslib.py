...
class SplusService:
  ...
  def batch_image_download_ms(
    ...
    **kwargs
    ...
    download_args = [
      {'ra': _ra, 'dec': _dec, 'save_path': Path(_save_path),'size': _size, **kwargs}
      for _ra, _dec, _save_path, _size in zip(ra, dec, save_path, sizes)
    ]
